        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (model.Email.Contains("@"))
            {
                ...
                if (User != null)
                {
                    ...
                    var resultado = await SignInManager.PasswordSignInAsync(User.UserName, model.Password, model.RememberMe, shouldLockout: false);
                    switch (resultado)
                    {
            ...
            // ApplicationUser signedUser = UserManager.FindByName(model.Email);
